...
K_THREAD_DEFINE(dht11PID,  DHT11_STACKSIZE,  ThreadDHT11,  NULL, NULL, NULL,DHT11_PRIORITY,  0, 0);
K_THREAD_DEFINE(bmp280PID, BMP280_STACKSIZE, BMP280Thread, NULL, NULL, NULL,BMP280_PRIORITY, 0, 0);
